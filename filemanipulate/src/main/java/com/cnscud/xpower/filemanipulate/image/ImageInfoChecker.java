 ...
 * <pre>
 * ImageInfoChecker ii = new ImageInfoChecker();
 ...
 * <pre>
 *   java ImageInfoChecker *.jpg *.png *.gif http://somesite.tld/image.jpg
 * </pre>
 * or call it without parameters and pipe data to it:
 * <pre>
 *   java ImageInfoChecker &lt; image.jpg
 * </pre>
 * <p>
 * Known limitations:
 * <ul>
 ...
 *  interlaced PNG and GIF. A new method {@link #isProgressive()} returns whether ImageInfoChecker
 ...
 *  that is examined by ImageInfoChecker is used for the "progressive" status.</li>
 ...
 *  Set package of ImageInfoChecker class to org.devlib.schmidt.imageinfo (a package
 ...
 *   Released as 1.8.</li>
 *  </li>
 *  <li><strong>2006-11-13</strong> Removed check that made ImageInfoChecker report JPEG APPx
 ...
 */
public class ImageInfoChecker {
	/**
	 * Return value of {@link #getFormat()} for JPEG streams.
	 * ImageInfoChecker can extract physical resolution and comments
	 ...
	 * ImageInfoChecker can extract comments from GIFs and count the number
	 ...
	 * but ImageInfoChecker is currently not able to extract those.
