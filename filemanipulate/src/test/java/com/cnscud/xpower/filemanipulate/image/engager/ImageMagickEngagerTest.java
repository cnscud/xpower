 ...
 * @version 1.0.0
 */
public class ImageMagickEngagerTest extends BaseEngagerTest {


    ImageMagickEngager engager = new ImageMagickEngager();
    ...
    public void testResizeImage() throws Exception {
        ...
        dealFiles4Engager("im_", files, requiredSizes);
    }
